...
job_finder_agent = Agent(
    role="Job Finder",
    goal="Find relevant job openings in India based on the CV details. Make sure openings found align with work experience duration, dominat role in the CV and key industries worked in",
...
job_search_task = Task(
    description="Search Google for job openings in India matching the given skills and work experience extracted from the CV. Extract only senioir roles (VP, Director, Lead etc.). Location should be Delhi-NCR, Bangalore, Pune, Hyderabad only",
